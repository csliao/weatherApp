...
const WeatherSetting = ({ handleCurrentPageChange, handleCurrentCityChange, cityName }) => {
  ...
  return (
    <WeatherSettingWrapper >
      ...
      {/* <StyledSelect id="location" name="location"  value={locationName} > */}
      <StyledSelect id="location" name="location" onChange={handleChange} ref={inputLocationRef} defaultValue='臺北市'>
